...
const SAMPLE_POSTS = [
  ...
  { id:4, author:'IceQueenMN', initials:'IQ', time:'1d ago', sport:'🏒 Hockey', title:'Vasilevskiy or Hellebuyck in the playoffs?', body:"Both are studs but I can only roster one. Vasy has the easier schedule this week but Hellebuyck's team is hotter. What are you guys doing?", likes:22, replies:19 },
  { id:5, author:'DraftDayDave', initials:'DD', time:'1d ago', sport:'🏀 Basketball', title:'SGA is locked and loaded — must own in all formats', body:"If you don't have Shai Gilgeous-Alexander in every league you're in, fix that immediately. The man is on another level right now.", likes:47, replies:23 },
];
